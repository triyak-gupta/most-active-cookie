...
- Java 11, Spring Boot, Maven (build tool)
...
~~~
java -jar target\most-active-cookie-version.jar -f csv-file-path -d selected-date
~~~

- Example:

~~~
java -jar target/most-active-cookie-0.0.1.jar -f cookie_log.csv -d 2018-12-09 
~~~
